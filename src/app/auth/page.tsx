      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 text-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-5 relative">
          <h1 className="text-5xl font-black leading-none tracking-tight">
            <span className="text-primary-400">Itilib</span>
          </h1>
          <Image src="/icons/logo.png" alt="Itilib" width={52} height={52}
        ...
        <p className="text-slate-600 text-sm relative">© 2026 Itilib. Tous droits réservés.</p>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="flex items-center gap-3 mb-8 lg:hidden">
              <Image src="/icons/logo.png" alt="Itilib" width={36} height={36} className="rounded-xl" />
              <span className="font-black text-xl text-slate-900 tracking-tight">Itilib</span>
            </div>
